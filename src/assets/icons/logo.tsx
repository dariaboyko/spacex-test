...
export const Logo = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 400 50" {...props}>
    ...
    />
    <g fill="#fff">
      <path d="M228.3 43.5v-9.4H247v-5.2h-28.1v20.4h41.5v-5.8zM219.9 18.6h41.9V24h-41.9z" />
    </g>
    <g fill="#fff">
      <path d="M287.6 18.6H273l17.2 12.6c2.5-1.7 5.4-3.5 8-5l-10.6-7.6zM308.8 34.3c-2.5 1.7-5 3.6-7.4 5.4l13 9.5h14.7l-20.3-14.9z" />
    </g>
    <path
